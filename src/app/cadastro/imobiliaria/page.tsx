...
export default function CadastroImobiliaria() {
    ...
    const handleRegister = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const specificData = {
            ...
            creci_juridico: formData.get('creci_juridico') as string,
            endereco_comercial: formData.get('endereco') as string,
            foto_logo: photoUrl // Adiciona a URL da logo
        };
        
        const response = await registerUser('imobiliaria', commonData, specificData);
        ...
        <div style={{ ...styles.pageContainer }}>
            <div style={{ ...styles.gradientContainer }}>
                <form onSubmit={handleRegister} style={{ ...styles.formContainer }}>
                    ...
                    <h2 style={{ color: '#004EFF', fontWeight: 'bold' }}>Cadastro de Imobiliária</h2>
                    ...
                    <div style={{ ...styles.grid, marginTop: '1rem' }}>
                        ...
                        <input type="text" name="creci_juridico" placeholder="CRECI Jurídico (Opcional)" style={{ ...styles.inputField }} />
...
// Estilos (Reutilizados do corretor)
